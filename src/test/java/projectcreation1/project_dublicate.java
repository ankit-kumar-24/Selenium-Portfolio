...
public class project_dublicate {
@Test
public void projdublicate() throws Exception {
	System.setProperty("webdriver.chrome.driver", "C:\\Selenium\\chromedriver.exe");	 
	  ...
	  Thread.sleep(2000);
	  driver.findElement(By.xpath("//span[contains(text(),'Duplicate project…')]")).click();
	  driver.findElement(By.cssSelector("div[class='section-step step-2 active'] button[class='btn btn-success ']")).click();
	  System.out.println("Dublicate project created successfully");
	  Thread.sleep(5000);
	  driver.close();
     }
}
